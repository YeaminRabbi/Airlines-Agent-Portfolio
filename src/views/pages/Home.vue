<template>
  <div>
    <section class="probootstrap-cover overflow-hidden relative"
      style="background-image: url('/assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5" id="section-home">
      <div class="overlay"></div>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md">
            <h2 class="heading mb-5 display-4 font-light probootstrap-animate">Explore The World With Ease</h2>
            <p class="lead mb-5 probootstrap-animate">
              <router-link class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3" :to="{ name: 'About'}">Read More</router-link>
            </p>
          </div>
              ...
              <div class="col-md-12 text-center mb-5 probootstrap-animate">
                ...
                <blockquote class="">
                  ...
                  <p class="probootstrap-author">
                    <a href="#" >
                      <img src="/assets/images/person_1.jpg" alt="Free Template by Techstring IT" class="rounded-circle">
    ...
    <section class="probootstrap_section" id="section-city-guides">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Top Package Tours</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="/assets/images/img_1.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <div class="probootstrap-text">
                <h3>Europe Group Tour</h3>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="/assets/images/img_2.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <h3>Thailand Group Tour</h3>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="/assets/images/img_3.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <h3>Russia Group Tour</h3>
            </a>
          </div>
    ...
    <section>
      <div class="container">
        <div class="row text-center mb-5 ">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Top Visa Process</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-6 mb-3">
            <a href="#">
              <img src="/assets/images/visa/BAHRAIN-300x300.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <div class="probootstrap-text mt-3">
                <h5>Bahrian Visa</h5>
                <span>$5,000.00</span>
              </div>
            </a>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <a href="#">
              <img src="/assets/images/visa/JAPAN-300x300.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <div class="probootstrap-text mt-3">
                <h5>Japan Visa</h5>
                <span>$8,000.00</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <a href="#">
              <img src="/assets/images/visa/MYANMAR-300x300.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <div class="probootstrap-text mt-3">
                <h5>Myanmar Visa</h5>
                <span>$7,000.00</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <a href="#">
              <img src="/assets/images/visa/QATAR-300x300.jpg" alt="Free Template by Techstring IT" class="img-fluid">
              <div class="probootstrap-text mt-3">
                <h5>Qatar Visa</h5>
                <span>$11,000.00</span>
              </div>
